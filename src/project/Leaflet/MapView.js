...
function MapsMap(props){
    let [currentLoc, setCurrenctLoc] = useState([props.loc1, props.loc2]);
    let [zoom, setZoom] = useState(7);
    // console.log(currentLoc);
    
    useEffect( () => { 
    setCurrenctLoc([props.loc1, props.loc2])
    console.log(currentLoc);
    ...
    return(
        <div className="mt-2 map col">
          <MapContainer center={currentLoc} zoom={7} scrollWheelZoom={false}>
          <TileLayer
